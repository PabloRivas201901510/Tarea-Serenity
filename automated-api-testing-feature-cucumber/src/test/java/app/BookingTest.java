...
public class BookingTest extends TestBase {
    ...
    public void searchBookingByFirstname(){
        List<String> bookings = steps.getByKey("Rachel", Endpoint.BOOKING_FIRSTNAME.getValue())
                .statusCode(200)
                .extract()
                .path("bookingid");
    ...
    @Test
    @Title("Search a booking by lastname name")
    public void searchBookingByLastname(){
        List<String> bookings = steps.getByKeyForLastname("Smith", Endpoint.BOOKING_LASTNAME.getValue())
                .statusCode(200)
                .extract()
                .path("bookingid");
